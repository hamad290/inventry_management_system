		...
		<div class="row">
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>J-Telemarketing</p>
			...
			<div class="col-md-8">
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						<div class="col-sm-6">
							<iframe src="http://free.timeanddate.com/clock/i616j2aa/n106/szw160/szh160/cf100/hnce1ead6" frameborder="0" width="160" height="160"></iframe>
