				...
				<div class="card" style="box-shadow:0 0 25px 0 lightgrey;">
				  ...
				  <div class="card-body">
				  	<form id="get_order_data" onsubmit="return false">
				  		...
				  		<div class="form-group row">
				  			<label class="col-sm-3 col-form-label" align="right">Customer Name & ID*</label>
				  			<div class="col-sm-6">
				  				<input type="text" id="cust_name" name="cust_name"class="form-control form-control-sm" placeholder="Enter Customer Name & ID" required/>
				  			</div>
				  		</div>
